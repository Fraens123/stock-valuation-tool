...
ASSUMPTION_LABELS = {
    ...
    "profitability_multiplier": "Rentabilitätsmultiplikator",
    "growth_addon": "KGV-Aufschlag Wachstum",
    "individuality_addon": "KGV-Aufschlag Individualität",
    "forecast_net_income": "Prognostizierter Jahresüberschuss",

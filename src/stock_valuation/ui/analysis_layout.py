...
ANALYSIS_SECTIONS: tuple[AnalysisSection, ...] = (
    ...
    AnalysisSection(
        ...
        (
            ...
            AnalysisPoint("debt_to_equity", "Verschuldung / Eigenkapital", "debt_to_equity", "debt_to_equity", "calculation", unit_hint="multiple"),
            ...
            AnalysisPoint("long_term_debt_to_equity", "Langfristige Finanzschulden / Eigenkapital", None, "debt_to_equity", "unsupported", NOT_CURRENTLY_IMPLEMENTED),
            AnalysisPoint("short_term_debt_to_equity", "Kurzfristige Finanzschulden / Eigenkapital", None, "debt_to_equity", "unsupported", NOT_CURRENTLY_IMPLEMENTED),
    ...
    AnalysisSection(
        ...
        (
            ...
            AnalysisPoint("latest_fy_pb", "Kurs-Buchwert-Verhältnis (KBV)", "latest_fy_pb", "latest_fy_pb", "valuation", unit_hint="multiple"),
            AnalysisPoint("latest_fy_p_ocf", "Kurs-Cashflow-Verhältnis (KCV)", "latest_fy_p_ocf", "latest_fy_p_ocf", "valuation", unit_hint="multiple"),
            ...
            AnalysisPoint("latest_fy_ev_sales", "EV / Umsatz", "latest_fy_ev_sales", "latest_fy_ev_sales", "valuation", unit_hint="multiple"),
            AnalysisPoint("latest_fy_ev_fcf", "EV / FCF", "latest_fy_ev_fcf", "latest_fy_ev_fcf", "valuation", unit_hint="multiple"),
        ),
    ),
    AnalysisSection(
        "dcf",
        ...
        (
            AnalysisPoint("owner_earnings", "1. Bestimmung Owner Earnings", "owner_earnings", "owner_earnings", "book"),
            AnalysisPoint("discount_rate_excel_book", "2. Bestimmung des Diskontierungsfaktors", "cost_of_equity", "cost_of_equity", "book", unit_hint="percent"),
            AnalysisPoint("terminal_value", "3. Bestimmung der Ewigen Rente", "terminal_value", "terminal_value", "book"),
            AnalysisPoint("fair_value", "4. Fairen Aktienkurs bestimmen", "fair_value", "fair_value", "valuation"),
            AnalysisPoint("margin_of_safety", "Sicherheitsmarge", "margin_of_safety", "margin_of_safety", "valuation", unit_hint="percent"),
        ),
    ),
    AnalysisSection(
        "quality",
        "12. Multiplikatorenmethode",
        "Die Excel-/Buchmethode führt vom Sockel-KGV über qualitative und quantitative Aufschläge zum fairen KGV.",
        (
            AnalysisPoint("base_pe", "Sockel-KGV", "base_pe", "base_pe", "book", unit_hint="multiple"),
            AnalysisPoint("financial_stability_addon", "Finanzielle Stabilität", "financial_stability_addon", "financial_stability_addon", "book", unit_hint="number"),
            AnalysisPoint("market_position", "Marktposition", "market_position", "market_position", "book", unit_hint="number"),
            AnalysisPoint("profitability_addon", "Rentabilität", "profitability_addon", "profitability_addon", "book", unit_hint="number"),
            AnalysisPoint("growth_addon", "Wachstum", "growth_addon", "growth_addon", "book", unit_hint="number"),
            AnalysisPoint("individuality_addon", "Individualität", "individuality_addon", "individuality_addon", "book", unit_hint="number"),
            AnalysisPoint("fair_pe", "Faires KGV", "fair_pe", "fair_pe", "book", unit_hint="multiple"),
            AnalysisPoint("multiplicator_fair_price_per_share", "Fairer Preis je Aktie", "multiplicator_fair_price_per_share", "multiplicator_fair_price_per_share", "book"),
        ),
    ),
    AnalysisSection(
        "summary",

...
ISSUE_LABELS_DE = {
    ...
    "MISSING_BASE_PE": "Sockel-KGV fehlt",
    "MISSING_FINANCIAL_STABILITY_ADDON": "Aufschlag fuer finanzielle Stabilitaet fehlt",
    "MISSING_MARKET_POSITION_ADDON": "Marktpositions-Aufschlag fehlt",
    "MISSING_PROFITABILITY_MULTIPLIER": "Rentabilitaetsmultiplikator fehlt",
    "MISSING_GROWTH_ADDON": "Wachstums-Aufschlag fehlt",
    "MISSING_INDIVIDUALITY_ADDON": "Individualitaets-Aufschlag fehlt",
    "MISSING_FORECAST_NET_INCOME": "Prognostizierter Jahresueberschuss fehlt",
    "MISSING_FORECAST_NET_INCOME_OR_SHARES": "Prognostizierter Gewinn oder Aktienzahl fehlt",
    "MISSING_FAIR_PE_OR_FORECAST_EPS": "Faires KGV oder prognostizierter Gewinn je Aktie fehlt",
    "MISSING_BASE_OWNER_EARNINGS": "Ausgangs-Owner-Earnings fehlen",
    "MISSING_GROWTH_RATE": "Wachstumsrate fehlt",
    "MISSING_PROJECTION_YEARS": "Planungszeitraum fehlt",
    "MISSING_TERMINAL_GROWTH_RATE": "Ewige Wachstumsrate fehlt",
    "MISSING_DISCOUNT_RATE": "Diskontierungszins fehlt",
    "MISSING_MARGIN_OF_SAFETY": "Sicherheitsmarge fehlt",
